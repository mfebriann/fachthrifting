    ...
    <section class="container mx-auto">
      ...
      <form method="POST" class="mt-7 flex flex-col gap-5">
        ...
        <div class="flex items-center gap-2">
          <input type="checkbox" name="produk-check" id="produk-check" class="w-5 h-5" <?= $isProduct === 'yes' ? "checked" : "" ?> onclick="return false;" readonly />
          <label for="produk-check" class="w-full text-sm text-slate-600 sm:text-base">Apakah ini berhubungan
            dengan produk?</label>
        </div>
        <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col gap-3">
          <label for="upload-bukti" class="text-slate-600">
            <?= $isProduct === 'yes' ? 'Gambar produk/Bukti transfer' : 'Bukti transfer' ?>
            <span class="text-xs text-slate-500">(Optional)</span>
          </label>
