        ...
        <table cellpadding="10">
          ...
          <tbody class="[&>*:nth-child(even)]:bg-white [&>*:nth-child(odd)]:bg-slate-100">
            <tr>
              ...
              <td>12/02/2024</td>
              <td>Muhammad Febrian</td>
              <td>Beli Sweater Crocodile</td>
              <td>RS12345678910</td>
              <td>Rp65.000</td>
              ...
              <td class="text-center">1</td>
              <td class="text-center">1</td>
              <td class="font-medium text-red-500">Pengeluaran</td>
            ...
            <tr>
              <td class="text-center">2</td>
              <td>01/01/2024</td>
              <td>Jajang Suhendar</td>
              <td>Menjual Sweater Crocodile</td>
              <td>-</td>
              <td>Rp65.000</td>
              ...
              <td class="text-center">-</td>
              <td class="text-center">-</td>
              <td class="font-medium text-green-500">Pemasukkan</td>
              <td class="text-center">
                <div class="flex gap-2">
                  <a href="view-transactions.php"
                    class="block w-max cursor-pointer rounded-md bg-blue-600 p-2 hover:opacity-75">
